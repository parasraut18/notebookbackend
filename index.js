...
// 1) New Method 
// Route 1) Create User   No login reqired
...
.then(()=>console.log("Datbase connection done")).catch((err)=>{
    console.log(err);
  })
...
// body('password','Password must be min 6 length').isLength({ min: 6 })],
// async (req,res)=>{
//   let success=  false;
...
//    // res.json({err:'Please enter unique value for url'})});
//    const data ={
//      user:{
//        id:user.id
//      }
